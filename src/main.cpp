...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 90;	// stake age of full weight: 90days
unsigned int nStakeTargetSpacing = 60;			// 60 sec block spacing

int64 nChainStartTime = 1417318818;
...
const string strMessageMagic = "LibraryCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if (nHeight == 1)
	{
		nSubsidy = 240000 * COIN;	// 240,000 coins
...
static const int64 nTargetTimespan = 10 * 60; // 10 blocks
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in LibraryCoin
    bool fStrictPayToScriptHash = true; // Always active in LibraryCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LibraryCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "LibraryCoin brings books to the poors.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xed1e80e935d37927df1442144d9340878a18a484d69258f0ae4bccb2c6a9b414"));
...
unsigned char pchMessageStart[4] = { 0xc4, 0xf2, 0xf3, 0xda };
